...
Resolve scripts from this skill directory and use the caller's interpreter and output location; [dependencies](../../README.md). Keep one plan through discovery, semantic selection and resumed depth. Return inspected evidence, receipts and unresolved gaps; a valid packet alone does not answer the research question.
